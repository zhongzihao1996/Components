<template>
  <div>
    <el-date-picker unlink-panels :picker-options="pickerOptions" v-model="innerDate" @change="dateChange" :type="type" :format="dateType" :value-format="dateType" :default-time="defaultTime"
      :range-separator="rangeSeparator" :placeholder="placeholder" :start-placeholder="startPlaceholder" :end-placeholder="endPlaceholder" :size="size" :editable="editable" :disabled="disabled"
      popper-class="date-picker-pop-panel" :class="{ 'has-second': dateType === 'yyyy-MM-dd HH:mm:ss' }">
    </el-date-picker>
  </div>
</template>
